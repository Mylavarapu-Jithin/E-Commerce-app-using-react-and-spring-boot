...
const SelectedTextField = ({label, select, setSelect, lists}) => {
  return (
    <Listbox value={select} onChange={setSelect}>
      <div className='flex flex-col gap-1 w-full'>
        ...
        <div className="relative">
            <ListboxButton 
            className={`relative text-sm py-2 rounded-md border border-slate-700  w-full cursor-default bg-white text-left text-gray-700 sm:text-sm sm:leading-6`}> 
