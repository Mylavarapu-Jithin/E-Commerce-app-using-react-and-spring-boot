...
const ProductCard = ({
  ...
  return (
    <div className='border rounded-lg shadow-xl overflow-hidden transition-shadow duration-300'>
      ...
      <img className='w-full h-full object-cover cursor-pointer transition-transform duration-300 transform hover:scale-105'
      ...
      {!about && (
        ...
        <button disabled={!isAvailable || btnLoader}  
             ...
             className={`bg-blue-500 ${isAvailable ? 'hover:bg-blue-600 opacity-100 cursor-pointer' : 'opacity-70'}
