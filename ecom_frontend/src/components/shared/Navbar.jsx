    ...
    <div className='h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0'>
      <div className='lg:px-14 sm:px-8 w-full flex justify-between'>
        <Link to="/" className='flex items-center text-2xl font-bold'>  
          ...
          <span className='font-[Poppins]'>Jithin-Shop</span>   
        </Link> 
        ...
        <ul className={`flex sm:gap-10 gap-4 sm:items-center text-slate-800 sm:static absolute left-0 top-[70px] sm:shadow-none shadow-md ${
          ...
          <li className='font-[400] transition-all duration-300'>
            <Link to='/' className={`${
          ...
          {user && user.id ? (
            ...
            <li className='font-[400] transition-all duration-300'>
              <Link to='/login' className='flex items-center space-x-2 py-[6px] bg-gradient-to-r from-purple-600
                                            to-red-500 text-white font-semibold rounded-md shadow-lg hover:from-purple-500
                                            hover:to-red-400 transition duration-300 ease-in-out transform px-2'>
                <FaSignInAlt /> 
                <span>Login</span>       
              </Link>   
            </li>  ) 
        ...
        <button  
            ...
            className='sm:hidden flex items-center sm:mt-0 mt-2'>
             {navbarOpen ? (
                  <RxCross2 className='text-3xl text-white cursor-pointer' />
             ) : (
