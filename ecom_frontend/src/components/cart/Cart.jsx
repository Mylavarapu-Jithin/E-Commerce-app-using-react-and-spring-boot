    ...
    <div className='lg:px-14 sm:px-8 px-4 py-10'>
      <div className='flex flex-col items-center mb-12'>
        <h1 className='text-4xl font-bold text-gray-900 flex items-center gap-3'>    
          <MdShoppingCart size={36} className='text-gray-900' />            
          Your Cart   
        </h1>
      ...
      <div className='grid md:grid-cols-5 grid-cols-4 gap-4 pb-2 font-semibold items-center'>
        <div className='md:col-span-2 justify-self-start text-lg text-slate-800 lg:px-4'>   
          Product 
        </div>
      ...
      <div className='border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between gap-4'>
        ...
        <div className='flex text-sm gap-1 flex-col'>
          ...
          <Link className='flex w-full justify-end' to='/checkout'>   
            <button className='font-semibold cursor-pointer w-[300px] py-2 px-4 rounded-sm bg-custom-blue text-white flex items-center justify-center gap-1
              hover:text-gray-300 transition duration-500'   
              onClick={() => {
