    ...
    <div className='flex flex-col items-center justify-center min-h-screen py-12 bg-cover'>  
      <div className='bg-white shadow-lg rounded-lg p-8 w-full max-w-lg'>
        ...
        <form className='space-y-4'>
          <div className='block text-sm font-medium text-700-gray'>
            <label>
              Name
            </label>
          ...
          <button className='w-full cursor-pointer bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition duration-150'>
            Send Message  
          </button>
        </form>
        ...
        <div className='mt-8 text-center'>
          ...
          <div className='flex flex-col items-center space-y-2 mt-4'>
            <div className='flex items-center'>  
              ...
              <span className='text-gray-600'>+91 6301593516</span>          
            </div>

            <div className='flex items-center'>  
              <FaEnvelope className='text-blue-500 mr-2' /> 
              <span className='text-gray-600'>mylavarapujithin@gmail.com</span>      
            </div>

            <div className='flex items-center'>  
              <FaMapMarkedAlt className='text-blue-500 mr-2' /> 
              <span className='text-gray-600'>Telangana, Khammam, Mamillagudem, Sai Bhargavi Apartments, 10-4-165, 166</span>          
            </div>      
          </div>
        </div>
      </div>
