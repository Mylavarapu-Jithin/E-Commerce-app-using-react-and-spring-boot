    ...
    <div className='max-w-7xl mx-auto px-4 py-8'>
      ...
      <div className='flex flex-col lg:flex-row justify-between items-center mb-12'>
        ...
        <div className='w-full md:w-1/4 mb-6 md:mb-0'>
          <img src="https://thewowstyle.com/wp-content/uploads/2015/01/nature-images..jpg" alt="About Us"
           className='h-85 w-85 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105' />      
        </div>
      </div>
      ...
      <div className='py-7 space-y-8'>  
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'> 
          {products.map((product, index) => (
            <ProductCard key={index} image={product.image} productName={product.productName} description={product.description} specialPrice={product.specialPrice} price={product.specialPrice} about />         
          ))  
          }
        </div>
      </div>
